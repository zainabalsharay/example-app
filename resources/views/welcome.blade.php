...
<body class="antialiased">
    ...
    <p>{{ 'This is name: ' . $obj->name . ' and id: ' . $obj->id . ' and age: ' . $obj->age }}</p>&nbsp;&nbsp;
    <p>{{ $name }}------{{ $age }}------{{ $city }}</p>&nbsp;&nbsp;
    <a href="{{ route('a', 3) }}">welcome</a>

    {{-- if condition in blade template view directives --}}
    @if ($name == 'reem')
        <p>yes iam zainab</p>
    @else
        <p>not iam zainab </p>
    ...
    {{-- forelse loop and empty --}}
    @forelse ($data2 as $key => $valu)
        <p>{{ $key }}---------------{{ $value }}</p>
    @empty
        <p>empty array</p>
    @endforelse
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <a href="{{ route('a', 5) }}"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">a</h2>
                    ...
                    <a href="{{ route('b') }}"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">b</h2>
